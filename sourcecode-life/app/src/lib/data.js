...
/* ================================================
   PLACEMENT-AWARE QUEST OBJECTIVES
   Keyed by placement (lp, cl, ex, so, ou, ac, th)
   then by root number (1-9, 11, 22, 33).
   4 objectives per slot — system rotates by day-of-year.
   ================================================ */

/* ================================================
   TIERED LIFE QUEST OBJECTIVES
   Keyed by root number (1-9, 11, 22, 33, 44).
   Each root has tiers 1/2/3 each with 3 strings.
   ================================================ */

const FIRST_NAME_MEANINGS = {
  1: {
    title: 'The Pioneer Name',
    text: `Your name carries the frequency of the initiator — the one who steps forward when others hesitate. People with a 1-frequency first name are wired to lead from the front. There is an innate drive toward independence, self-reliance, and original thought baked into how you introduce yourself to the world. Your name announces you before you speak. It carries an energy that pushes toward self-definition — the refusal to be a copy of anyone else. The shadow is isolation; the gift is that you never need permission to begin.`,
  },
  2: {
    title: 'The Bridge Name',
    text: `Your name resonates with the frequency of union — the subtle force that holds opposing things together. A 2-frequency first name gives you a natural sensitivity to the emotional field around you. You read people before they speak. You sense tension in rooms and instinctively move to smooth it. This name frequency makes you a natural mediator, partner, and supporter. Your greatest power is not in grand gestures but in the quiet steadiness you bring to relationships. The shadow is self-erasure; the gift is that you can hold space like no one else.`,
  },
  3: {
    title: 'The Voice Name',
    text: `Your name pulses with creative expression — it was made to be spoken aloud. A 3-frequency first name carries an inherent joyfulness and a magnetism that draws people in. You are wired to communicate, create, and inspire. Words come naturally, art flows through you, and your presence tends to lift the energy of whatever room you enter. This frequency is the one that turns pain into story and darkness into something beautiful. The shadow is scattered energy or performance without depth; the gift is that you carry light in your name.`,
  },
  4: {
    title: 'The Architect Name',
    text: `Your name is built on bedrock. A 4-frequency first name carries a grounded, structural energy — the frequency of the builder, the organizer, the one who shows up and does the work without needing applause. You bring order to chaos. Your presence creates stability for those around you. This name frequency gives you an instinctive respect for process, systems, and the value of patience. Others may move faster, but your foundations hold. The shadow is rigidity; the gift is that everything you build actually lasts.`,
  },
  5: {
    title: 'The Catalyst Name',
    text: `Your name vibrates with change, freedom, and the restless hunger for experience. A 5-frequency first name marks you as someone who cannot be contained by routine — your energy needs movement, variety, and new horizons to stay alive. You are the disruptor, the adventurer, the one who asks "what else?" You adapt faster than most and inspire others to loosen their grip on the familiar. The shadow is instability or chronic escapism; the gift is that you keep the world from going stale.`,
  },
  6: {
    title: 'The Hearth Name',
    text: `Your name carries the frequency of responsibility, beauty, and deep care. A 6-frequency first name makes you someone people naturally lean on — you radiate warmth and a desire to make things right. You are drawn to creating harmony in your home, your relationships, and your community. Your name comes with an innate sense of duty and a strong aesthetic instinct — you notice when things are out of balance and feel compelled to restore it. The shadow is over-responsibility or martyrdom; the gift is that you know how to love with your whole self.`,
  },
  7: {
    title: 'The Seeker Name',
    text: `Your name carries the frequency of depth, mystery, and inner knowing. A 7-frequency first name marks you as someone whose inner world is richer and stranger than most people realize. You are drawn to questions that don't have easy answers — the spiritual, the hidden, the precise truth beneath surface appearances. Others may find you hard to fully know, because your name keeps most of what you are below the surface. The shadow is isolation or distrust; the gift is that you hold a quality of stillness and wisdom that others sense without being able to name.`,
  },
  8: {
    title: 'The Authority Name',
    text: `Your name carries the frequency of power — material, structural, and karmic. An 8-frequency first name gives you an innate command presence. You understand systems, leverage, and the long game. People sense your capacity to lead in the material world — whether in business, strategy, or execution. This frequency comes with both great potential and great responsibility; the 8 has no neutral setting. The shadow is dominance or the relentless chase of status; the gift is that when you align power with purpose, you become genuinely unstoppable.`,
  },
  9: {
    title: 'The Elder Name',
    text: `Your name carries the frequency of completion — the energy of someone who has been here before and carries the weight of it. A 9-frequency first name marks you as a natural empath, idealist, and humanitarian. You feel the world's pain acutely and are drawn toward healing, teaching, and letting go. Your name carries an old-soul quality that others feel even if they can't explain it. You are here not to accumulate but to transmit. The shadow is martyrdom or the inability to release what no longer serves; the gift is that your compassion can touch something universal.`,
  },
};

export { ROOT, STRIPS, CALLING, COMPOUND_DESC, GIFTS, NUM_QUESTS, MASTER_QUESTS, MAIN_QUEST_DATA, ELECTRIC_NUMS, MAGNETIC_NUMS, AETHER_NUMS, STAT_NAMES, POLARITY_COLORS, POLARITY_CONFIGS, AETHER_TIERS, ROOT_INFLUENCE, DIGIT_INFLUENCE, LP_INTO_CALLING, EX_INTO_CALLING, FIELD_LABELS, CYCLE_MEANINGS, CYCLE_QUEST_COLORS, MONTH_NAMES, FIRST_NAME_MEANINGS };