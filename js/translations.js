...
var SSC_TRANSLATIONS = {
  ...
  'about.s1.body' : { en: 'Simulation Source Code began after a series of uneffective readings from Numerologists of the time. Continually told "your life will be filled with heartache and challange. You will have a hard life", as anyone would understand, I was not satisfied nor believed in their interpretation. For some reason, I was compelled to find meaning still within the numbers. After a decade of life, experiences, learning and expirimenting, Simulation Source Code Was Born.', es: 'Simulation Source Code comenzó después de una serie de lecturas inefectivas de Numerólogos de la época. Continuamente me decían "tu vida estará llena de angustia y desafío. Tendrás una vida difícil", y como cualquiera entendería, no estaba satisfecho ni creía en su interpretación. Por alguna razón, estaba impulsado a encontrar significado aún dentro de los números. Después de una década de vida, experiencias, aprendizaje y experimentación, Simulation Source Code Nació.' },
  'about.s1.title' : { en: '· The Origin ·', es: '· La Filosofía ·' },
  'about.s2.body' : { en: 'We use the Pythagorean system as our foundation, but applying new concepts deriving from experience and learning about simulation theory, consciousness, quantum physics and Spirituality as a whole. Every reading delivers seven core frequencies, each calculated precisely from your birth data and name. Interpretations are practical and useful &#8212; offering direction and objectives for growth as opposed to mere dictation.', es: 'Usamos el sistema pitagórico como fundamento, mientras nos nutrimos de tradiciones esotéricas más profundas para enriquecer la interpretación. Cada lectura entrega siete frecuencias centrales, cada una calculada con precisión a partir de tus datos de nacimiento y nombre. Las interpretaciones son honestas, matizadas y útiles — cada frecuencia contiene luz y sombra, don y desafío.' },
